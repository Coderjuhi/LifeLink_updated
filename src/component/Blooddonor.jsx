      ...
      <nav className="fixed top-0 left-0 w-full h-16 bg-white/95 backdrop-blur-md text-gray-900 z-50 border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto h-full px-4 md:px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <button className="hidden sm:flex items-center gap-2 px-3 py-1.5 text-red-600 hover:bg-red-50 rounded-lg transition-colors font-medium text-sm">
                  ...
                  {["blood", "organs"].map((tab) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium text-sm transition-all ${
                        activeTab === tab ? "bg-red-600 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                      }`}
                    >
            ...
            <div className="space-y-6">
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Juhi Gupta</p>
                ...
                <div className="space-y-3 mb-6 pb-6 border-b border-gray-100">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900">Sep 21, 2025</span>
                  </div>
                  <div className="flex justify-between text-sm">
