        ...
        <>
            ...
            <section className="w-full bg-red-50 mt-12">
                <div className="max-w-6xl mx-auto text-center px-6 py-12 min-h-[60vh]">
                    ...
                    <div className="flex justify-center gap-4">
                        <button className="px-6 py-3 bg-pink-600 text-white font-medium rounded-lg hover:bg-pink-700 transition">
                            <FaRegHeart className="inline text-white mr-2" />
                            Become a Donor
                        </button>
                        <button className="px-6 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-100 transition">
                            Find Help <BsArrowRight className="inline" />
            ...
            <section className="w-full bg-pink-50 min-h-screen pt-[100px] px-6">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    ">
                        {/* Card 1 */}
                        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg border border-transparent hover:border-pink-500 transition">
                        ...
                        {/* Card 2 */}
                        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg border border-transparent hover:border-red-400 transition">
                        ...
                        {/* Card 3 */}
                        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg border border-transparent hover:border-green-500 transition">
                        ...
                        {/* Card 4 */}
                        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg border border-transparent hover:border-purple-500 transition">
                        ...
                        {/* Card 5 */}
                        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg border border-transparent hover:border-teal-500 transition">
                        ...
                        {/* Card 6 */}
                        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg border border-transparent hover:border-orange-400 transition">
