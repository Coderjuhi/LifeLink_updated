...
export default function Signin({ setUser }) {
  ...
  return (
    ...
    <div className="min-h-screen bg-linear-to-r from-pink-50 to-pink-100 flex flex-col items-center justify-center p-6">  

      {successMsg && (
        <div className="bg-green-50 border border-green-200 text-green-700 rounded-lg p-3 mb-4 font-medium">
          ✓ Login Successful
        </div>
      )}
